...
using static SacrificeHelper.SacrificeHelperMod;
...
public class TSMThemeChanges
{
    ...
    private static void TowerInfoChanged(TSMThemeDefault __instance, TowerToSimulation tower)
    {
        ...
        {
            ModContent.GetInstance<SacrificeHelperMod>().OnGameObjectsReset();
        }
    ...
    private static void SetUpTempleUI(TSMThemeDefault __instance)
    {
        ...
        image.SetSprite(ModContent.GetSprite<SacrificeHelperMod>(templeSacrificesOff ? "Off" : "On"));
